...
function load_style_script(){
	...
	wp_enqueue_style('my-googlefonts', 'https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300..800;1,300..800&display=swap');
	wp_enqueue_style('my-fontawesome', get_stylesheet_directory_uri() . '/fonts/FA5PRO-master/css/all.css');
